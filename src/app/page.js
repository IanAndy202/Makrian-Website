...
// ⬇️ you're inside /about, so go up one level to components
...
@@ -57,100 +57,203 @@ export default function AboutPage() {
  ...
  return (
    ...
    <main className="bg-[#fdf8f3] text-[#001D61] scroll-smooth">
        ...
        <motion.section id="about" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }}
          whileHover={{ scale: 1.08 }} className="transition-transform duration-500 bg-[#fdf8f3] hover:bg-[#f3f0ec] py-16 px-6 text-center">
        ...
        {/* Mission */}
        <motion.section id="mission" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }}
          whileHover={{ scale: 1.08 }} className="transition-transform duration-500 bg-[#f5f3ef] py-16 px-6 text-center">
        ...
        {/* Value & Strategy */}
        <motion.section id="value-prop" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {valuePoints.map((p, i) => (
                    <motion.li key={i} custom={i} variants={pointVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}
...
Credit, Surety, Cyber, Energy, and Aviation, along with Microinsurance and Bond Insurance.
      ...
      >
        ...
        {/* Founder */}
        <motion.section id="founder" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }}
          whileHover={{ scale: 1.08 }} className="transition-transform duration-500 bg-[#fdf8f3] hover:bg-[#f3f0ec] py-16 px-6">
        ...
        <motion.section variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-10 max-w-6xl mx-auto">
            ...
            <div className="max-w-md text-left text-lg leading-relaxed">
              <p>We serve clients across Kenya (Nairobi HQ), East/Central/Southern Africa, CIMA Region, Middle East & Asia.</p>
            </div>
        </div>
      </motion.section>
      ...
      <motion.section
        ...
        className="transition-transform duration-500 bg-[#fdf8f3] hover:bg-[#f3f0ec] py-16 px-6 text-center"
      >
        <h2 className="text-3xl font-bold mb-10">Our Reach: Africa, Middle & Asia</h2>
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 max-w-6xl mx-auto">
          <Image
            src="/bluemap.png"
            alt="Makrian Reach"
